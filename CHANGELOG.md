...
* add account creation endpoint with optional portfolioId :sparkles: ([eb51270](https://github.com/LerianStudio/midaz-fork/commit/eb51270a3c36d32975140a0e6df6188080e31fe1))
* add account update endpoint without portfolioId :sparkles: ([3d7ea8f](https://github.com/LerianStudio/midaz-fork/commit/3d7ea8f754faef82d07fdbc519ebe7595fe1ee89))
* add antlr4 in go mod and update to 1.22 :sparkles: ([81ae7bb](https://github.com/LerianStudio/midaz-fork/commit/81ae7bb6e0353a5a3df48a0022a32d49991c8c62))
* add authorization to Postman requests and implement new transaction route wip :sparkles: ([91afb3f](https://github.com/LerianStudio/midaz-fork/commit/91afb3f26c6d4912a669120ab074f14011b88d10))
* add default enforcer adapter and token fields on casdoor init json also add init sql file to casdoor db :sparkles: ([6bb997b](https://github.com/LerianStudio/midaz-fork/commit/6bb997b7ef3b564be1869d1ffef1e142f6236c7d))
* add definitions and config :sparkles: ([a49b010](https://github.com/LerianStudio/midaz-fork/commit/a49b010269122600bdf6ed0fa02a5b6aa9f703d4))
* add endpoint for account deleting without portfolioID :sparkles: ([075ba90](https://github.com/LerianStudio/midaz-fork/commit/075ba9032fe35f4ac125807a8e6cf719babcf33b))
* add endpoints for account consulting with optional portfolioID :sparkles: ([910228b](https://github.com/LerianStudio/midaz-fork/commit/910228bc2da1231d3a6f516d39cca63a44dfa787))
* add func to extract and validate parameters :sparkles: ([fab06d1](https://github.com/LerianStudio/midaz-fork/commit/fab06d1d299477d765884d6b2f64cb6d49819cef))
* add grafana-lgtm and open telemetry collector to infra docker-compose :sparkles: ([6351d3b](https://github.com/LerianStudio/midaz-fork/commit/6351d3bc5db24ac09afa693909ee2725c2a5b012))
* add grpc port to midaz on 50051 to run togheter with fiber :sparkles: ([a9c4551](https://github.com/LerianStudio/midaz-fork/commit/a9c45514be5239593b9a26d1838d140c372d3836))
* add implementation to paginate organization in postgresql only :sparkles: ([33f9b0a](https://github.com/LerianStudio/midaz-fork/commit/33f9b0a3e4ff8ca559e5180bd9fbf458c65cc2fe))
* add infra to template; :sparkles: ([f18dca9](https://github.com/LerianStudio/midaz-fork/commit/f18dca99754eb5c0aa71936c075979c27048bb53))
* add make all-services that can run all services in the makefile :sparkles: ([20637eb](https://github.com/LerianStudio/midaz-fork/commit/20637eb3e50eaa00b8c58ef4bf4dea4d2deb8a2b))
* add midaz version :sparkles: ([27c56aa](https://github.com/LerianStudio/midaz-fork/commit/27c56aac4aaeffbdd6093a69dbc80e84ea9331ee))
* add migration to create extension "uuid-ossp" on schema public :sparkles: ([fceb8b0](https://github.com/LerianStudio/midaz-fork/commit/fceb8b00f49b57dc95d28f1df507f2333bfa7521))
* add new funcs to solve some problems separately :sparkles: ([c88dd61](https://github.com/LerianStudio/midaz-fork/commit/c88dd6163837534d330211f9233262a986f6ac15))
* add opentelemetry traces to account endpoints :sparkles: ([bf7f043](https://github.com/LerianStudio/midaz-fork/commit/bf7f04303d36e15a61af5fb1dde1476e658e5029))
* add opentelemetry traces to account endpoints and abstract context functions in common package :sparkles: ([c5861e7](https://github.com/LerianStudio/midaz-fork/commit/c5861e733ec390f9da92f53d221347ecc3046701))
* add opentelemetry traces to asset endpoints :sparkles: ([3eb7f9a](https://github.com/LerianStudio/midaz-fork/commit/3eb7f9a34e166fc7a0d798f49ac4ccfb5dc62b8a))
* add opentelemetry traces to operation endpoints and update business error responses :sparkles: ([b6568b8](https://github.com/LerianStudio/midaz-fork/commit/b6568b8369c8ebca79bbc19266981353026da545))
* add opentelemetry traces to portfolio endpoints :sparkles: ([cc442f8](https://github.com/LerianStudio/midaz-fork/commit/cc442f85568e7717de706c73a9515400a4bfa651))
* add opentelemetry traces to products endpoints :sparkles: ([2f3e78a](https://github.com/LerianStudio/midaz-fork/commit/2f3e78a7d2f4ef71fc29abc51b9183d5685f568b))
* add opentelemetry traces to transaction endpoints :sparkles: ([442c71f](https://github.com/LerianStudio/midaz-fork/commit/442c71f0a06182d7adfdf2579d50247e3500d863))
* add opentelemetry tracing propagation to transaction and ledger endpoints :sparkles: ([19d8e51](https://github.com/LerianStudio/midaz-fork/commit/19d8e518e367a993051974ff1a2174e9bfaa3d57))
* add pagination instrument postgresql :sparkles: ([2427093](https://github.com/LerianStudio/midaz-fork/commit/24270935db8b24499d441751cdb94ef606bc8532))
* add pagination ledger postgresql :sparkles: ([a96fe64](https://github.com/LerianStudio/midaz-fork/commit/a96fe64160ba03e6fec57475f8fec1ef44fcd95c))
* add pagination portfolio postgresql :sparkles: ([3f57b98](https://github.com/LerianStudio/midaz-fork/commit/3f57b98c34a63d6daae256dfe781086902c9e81b))
* add pagination response :sparkles: ([b1221c9](https://github.com/LerianStudio/midaz-fork/commit/b1221c94fefd038dfd850ca45d0a8a097c7d4c53))
* add pagination to account only postgresql :sparkles: ([86d4a73](https://github.com/LerianStudio/midaz-fork/commit/86d4a73d4b9ec7f026f929b4cede5ec026de3343))
* add pagination to metadata :sparkles: ([5b09efe](https://github.com/LerianStudio/midaz-fork/commit/5b09efebeaa5409f6d0f36a72acee5814c6bc833))
* add pagination to metadata accounts :sparkles: ([2c23e95](https://github.com/LerianStudio/midaz-fork/commit/2c23e95c29b3c885f70eb1c2ad419a064ad4b448))
* add pagination to metadata instrument :sparkles: ([7c9b344](https://github.com/LerianStudio/midaz-fork/commit/7c9b3449b404616a95c57d136355fed80b3d2c71))
* add pagination to metadata ledger :sparkles: ([421a473](https://github.com/LerianStudio/midaz-fork/commit/421a4736532daffbee10168113143d3263f0939e))
* add pagination to metadata mock and tests :sparkles: ([e97efa7](https://github.com/LerianStudio/midaz-fork/commit/e97efa71c928e8583fa92961053fa713f9fb9e0d))
* add pagination to metadata organization :sparkles: ([7388b29](https://github.com/LerianStudio/midaz-fork/commit/7388b296adefb9e288cfe9252d3c0b20dbc27931))
* add pagination to metadata portfolios :sparkles: ([47c4e15](https://github.com/LerianStudio/midaz-fork/commit/47c4e15f4b701a7b9da9dbc33b2f216fc08763b0))
* add pagination to metadata products :sparkles: ([3cfea5c](https://github.com/LerianStudio/midaz-fork/commit/3cfea5cc996661d7e912e7b5540acdd4defe2fa0))
* add pagination to product, only postgresql :sparkles: ([eb0f981](https://github.com/LerianStudio/midaz-fork/commit/eb0f9818dd25a6ec676a0556c7df7af80e1afb46))
* add permission check to ledger :sparkles: ([352a6c2](https://github.com/LerianStudio/midaz-fork/commit/352a6c295aa57e0ebc4c9df52a36ce8beb6db811))
* add permission check to the ledger grpc routes :sparkles: ([1e4a81f](https://github.com/LerianStudio/midaz-fork/commit/1e4a81f14a3187c0b9de88017a2bb25262494bf5))
* add permission check to the ledger routes :sparkles: ([4ce5162](https://github.com/LerianStudio/midaz-fork/commit/4ce5162df5c06018bb9552168fb02c250768cad5))
* add proto url, address :sparkles: ([c92ee9b](https://github.com/LerianStudio/midaz-fork/commit/c92ee9bc2649a3c46963027e067c4eed4dddade4))
* add readme to show antlr and trillian in transaction :sparkles: ([3c12b13](https://github.com/LerianStudio/midaz-fork/commit/3c12b133dc90aee4275944b421bee661d6b9e363))
* add repository on command and query :sparkles: ([94d254a](https://github.com/LerianStudio/midaz-fork/commit/94d254ae9e74ce7ac9509e625228eba019b4e7a1))
* add squirrel and update go mod tidy :sparkles: ([e4bdeed](https://github.com/LerianStudio/midaz-fork/commit/e4bdeeddbe9783b086799d59c365105f4dc32c7d))
* add the gold language that use antlr4, with your parser, lexer and listeners into commons :sparkles: ([4855c21](https://github.com/LerianStudio/midaz-fork/commit/4855c2189dfbeaf458ba35476d1216bb6666aeca))
* add traces to the ledger endpoints using opentelemetry :sparkles: ([4c7944b](https://github.com/LerianStudio/midaz-fork/commit/4c7944baeb13f1a410960437b9306feb9c581f44))
* add traces to the organization endpoints using opentelemetry :sparkles: ([cc3c62f](https://github.com/LerianStudio/midaz-fork/commit/cc3c62f03688f6847122d6cb65dec8703d86b0b5))
* add tracing telemetry to create organization endpoint :sparkles: ([b1b2f11](https://github.com/LerianStudio/midaz-fork/commit/b1b2f115607b34777a1024226544f5c0e017b083))
* add transaction templates ([a55b583](https://github.com/LerianStudio/midaz-fork/commit/a55b5839944e385a94037c20aae5e8b9a415a503))
* add transaction to components and update commands into the main make :sparkles: ([40037a3](https://github.com/LerianStudio/midaz-fork/commit/40037a3bb3b19415133ea7cb937fdac1d797d66e))
* add trillina log temper and refact some container names ([f827d96](https://github.com/LerianStudio/midaz-fork/commit/f827d96317884e419c2579472b3929eb14888951))
* add update account with status approved after transfers :sparkles: ([f84ee03](https://github.com/LerianStudio/midaz-fork/commit/f84ee038bd5792fb72b3bcfa12dec6fdcac2ce73))
* add uuid handler for routes with path parammeters :sparkles: ([f95111e](https://github.com/LerianStudio/midaz-fork/commit/f95111ec4c8dabcb81959b3e0306219fb95080b3))
* add version onn .env file :sparkles: ([fdfdac3](https://github.com/LerianStudio/midaz-fork/commit/fdfdac3bded8767307d7f1e3d68a3c76e5803aa8))
* added command product in root ([d0c2f89](https://github.com/LerianStudio/midaz-fork/commit/d0c2f898e2ad29fc864eb3545b0cd0eb86caaec3))
* added new sub command create on command portfolio ([5692c79](https://github.com/LerianStudio/midaz-fork/commit/5692c791119335da27657b91eaca1933401669d0))
* added new sub command create on command product ([9c63088](https://github.com/LerianStudio/midaz-fork/commit/9c63088ffa88747e95a7254f49d8d00c180e1434))
* added new sub command delete on command asset ([d7a91f4](https://github.com/LerianStudio/midaz-fork/commit/d7a91f44198d519e6d122d8091a137c37cbdd708))
* added new sub command delete on command portfolio ([ee48586](https://github.com/LerianStudio/midaz-fork/commit/ee48586a91e40e2ffe1983bacb36c1bc6ef56c6d))
* added new sub command describe on command asset ([5d14dab](https://github.com/LerianStudio/midaz-fork/commit/5d14dabe4a67a3e97f2cd52fa33f50b27bec782a))
* added new sub command describe on command portfolio ([0d3b154](https://github.com/LerianStudio/midaz-fork/commit/0d3b15451d48b234d72e726fd09f5116706b6c34))
* added new sub command list on command portfolio ([d652feb](https://github.com/LerianStudio/midaz-fork/commit/d652feb3e175835dd2590cf2942abf58d5dcd18b))
* added new sub command list on command portfolio ([11f6f07](https://github.com/LerianStudio/midaz-fork/commit/11f6f079c70bab16058747bc7e6fca34a10a132c))
* added new sub command update on command asset ([2edf239](https://github.com/LerianStudio/midaz-fork/commit/2edf2397b13dbbc114937ad3e20192b34931c5a7))
* added new sub command update on command portfolio ([87e9977](https://github.com/LerianStudio/midaz-fork/commit/87e99770563db5dd6afe37326e27c0e6b0b63816))
* added sub command delete from organization ([99dbf17](https://github.com/LerianStudio/midaz-fork/commit/99dbf176bd39cb81585d589158061d633aee65c7))
* added sub command list from organization ([32ecea1](https://github.com/LerianStudio/midaz-fork/commit/32ecea1811ace742647b8dfa3ee4b20a69c9a7bb))
* added sub command list from organization ([dfcaab0](https://github.com/LerianStudio/midaz-fork/commit/dfcaab041769dd87f313d1effe21dda384f01286))
* added sub command update from organization ([7945691](https://github.com/LerianStudio/midaz-fork/commit/7945691afb1c4c434b7c96cc50c0c200f6a4d513))
* adds new error message for metadata nested structures :sparkles: ([4a7c634](https://github.com/LerianStudio/midaz-fork/commit/4a7c634194f1b614e6754cd94e4d1416716e51b5))
* adds UUID handler for routes with path parameters :sparkles: ([6153896](https://github.com/LerianStudio/midaz-fork/commit/6153896bc83e0d3048a7223f89eafe6b6f2deae3))
* adds validation error for invalid path parameters :sparkles: ([270ecfd](https://github.com/LerianStudio/midaz-fork/commit/270ecfdc7aa14040aefa29ab09710aa6274acce9))
* adjust wire inject :sparkles: ([ca0ddb4](https://github.com/LerianStudio/midaz-fork/commit/ca0ddb40cd490353126108fe36334241f7cb714c))
* adjusts to create operations based on transaction in dsl :sparkles: ([7ca7f04](https://github.com/LerianStudio/midaz-fork/commit/7ca7f04f3e651d584223b0956b60751e89ecc671))
* business message :sparkles: ([c6e3c97](https://github.com/LerianStudio/midaz-fork/commit/c6e3c979edfd578d61f88525360d771336be7da8))
* create a func process account on handler to update accounts :sparkles: ([67ba62b](https://github.com/LerianStudio/midaz-fork/commit/67ba62bf124584cf47caae1bae9c4729294d0ac3))
* Create asset rates - part 2 :sparkles: ([c2d636c](https://github.com/LerianStudio/midaz-fork/commit/c2d636c32a2fd83aeff6005aaeb599994a260b3c))
* Create asset rates :sparkles: ([5e4519f](https://github.com/LerianStudio/midaz-fork/commit/5e4519f6e64e65b094bfff685e4ac0221e3183c7))
* create auth postman collections and environments ([206ffb1](https://github.com/LerianStudio/midaz-fork/commit/206ffb14845f78a98180d72eafc02c4b281b43a1))
* create casdoor base infrastructure ✨ ([1d10d20](https://github.com/LerianStudio/midaz-fork/commit/1d10d20a52df2d4f7e95b752eecd513c56565dca))
* create comamnd ledger and sub command create ([d4a8538](https://github.com/LerianStudio/midaz-fork/commit/d4a85386237e2ca040587591cc7c8a489d9c44dd))
* create command create from organization ([c0742da](https://github.com/LerianStudio/midaz-fork/commit/c0742daa8afa6dd4d3e45a38760a64c9b7559a2c))
* create command login mode term, browser :sparkles: ([80a9326](https://github.com/LerianStudio/midaz-fork/commit/80a932663d5e2747b59fb740a46d828a852e10a9))
* **transaction:** create connection files and add amqp on go.mod :sparkles: ([63f816f](https://github.com/LerianStudio/midaz-fork/commit/63f816fcc7d64b570b8495a1ee338e6891ee520a))
* **asset:** create external account if it does not exist during asset creation :sparkles: ([c88b220](https://github.com/LerianStudio/midaz-fork/commit/c88b220e240c0924e1077797ab91d6e05c23472c))
* create func on validate to adjust values to send to update :sparkles: ([8ffe1ce](https://github.com/LerianStudio/midaz-fork/commit/8ffe1ce51a9c408fbcbe2625900b3a3a85cd91fe))
* create grpc account in adapter :sparkles: ([78dbddb](https://github.com/LerianStudio/midaz-fork/commit/78dbddb255c0dd73c74e32c4a049d59af88f6a04))
* create method that search instrument by name or code to cant insert again ([8e01080](https://github.com/LerianStudio/midaz-fork/commit/8e01080e7a44656568b66aed0bfeee6dc6b336a7))
* create mocks based on repositories :sparkles: ([f737239](https://github.com/LerianStudio/midaz-fork/commit/f737239876cf9ad944289e4d3ea1491bf37003dd))
* create new method findbyalias :sparkles: ([6d86734](https://github.com/LerianStudio/midaz-fork/commit/6d867340c58251cb45f13c08b89124187cb1e8f7))
* create new method listbyalias to find accounts based on transaction dsl info :sparkles: ([113c00c](https://github.com/LerianStudio/midaz-fork/commit/113c00c2b64f2577f01460b1e4a017d3750f16ea))
* create new route and server grpc and remove old account class :sparkles: ([c5d9101](https://github.com/LerianStudio/midaz-fork/commit/c5d91011efbc8f0dca1c32091747a36abe3d6039))
* create operation const in commons :sparkles: ([b204230](https://github.com/LerianStudio/midaz-fork/commit/b204230da55f4ebe699f45400bc3dc7350d37e91))
* create operation postgres crud to use with transaction ([0b541a4](https://github.com/LerianStudio/midaz-fork/commit/0b541a48086bc8336085bee3e71606bd1b55d13f))
* create producer and consumer repositories :sparkles: ([474d2d0](https://github.com/LerianStudio/midaz-fork/commit/474d2d052a32930b75e4abb3cd1be6dc04da1092))
* create rabbitmq handler on ports/http :sparkles: ([96b6b23](https://github.com/LerianStudio/midaz-fork/commit/96b6b23c9a0e6e8b31ea3329f3b7082a0ecdcb93))
* create rest create ledger ([a0435ac](https://github.com/LerianStudio/midaz-fork/commit/a0435acd44ececb0977c90e92a402809b7348bad))
* create rest get by id asset ([059d6a1](https://github.com/LerianStudio/midaz-fork/commit/059d6a187a9c4ef2905249e5dc60527451c3fbec))
* create rest get by id portfolio ([97db29c](https://github.com/LerianStudio/midaz-fork/commit/97db29c26661494c78809ad6109cee5907109c9c))
* create rest getby id organization ([3959de5](https://github.com/LerianStudio/midaz-fork/commit/3959de5ccb65804255e96b9c455f7dfbc87563dc))
* create rest list ledger ([88102a2](https://github.com/LerianStudio/midaz-fork/commit/88102a215dbbeec4089560da09f4c644c4743784))
* create rest update ledger ([b2f8129](https://github.com/LerianStudio/midaz-fork/commit/b2f81295f8773a4d5b4c26e7d306122d1c2f1ee8))
* create some validations func to scale, undoscale and so on... :sparkles: ([3471f2b](https://github.com/LerianStudio/midaz-fork/commit/3471f2b9cb34c20573695a23e746dfc27bfd6fe5))
* create struct generic to pagination :sparkles: ([af48647](https://github.com/LerianStudio/midaz-fork/commit/af48647b3ce1922d6185258489f6f0fdabee58da))
* create sub command delete from command ledger with test unit of the command delete ([63de66e](https://github.com/LerianStudio/midaz-fork/commit/63de66eff8e604e13bae20d3842c4c6302f93503))
* create sub command describe from command organization ([af35793](https://github.com/LerianStudio/midaz-fork/commit/af35793c0c1b1f27ab46b735daf48a3ce52c598d))
* create sub command describe from ledger and test unit ([418e660](https://github.com/LerianStudio/midaz-fork/commit/418e6600e37cc2ab303b6fe278477c66ef6865f0))
* create sub command list from ledger and test unit with output golden ([3d68791](https://github.com/LerianStudio/midaz-fork/commit/3d68791977bb3ebfd8876de7c75d7c744bcb28f1))
* create sub command update from command ledger ([57fc305](https://github.com/LerianStudio/midaz-fork/commit/57fc305d5bfd7cd6eaab25c651b27c3bb604a02b))
* create test to producer and consumer; :sparkles: ([929d825](https://github.com/LerianStudio/midaz-fork/commit/929d825ba8749aab4520e4dac7a8109125f27952))
* create transaction constant :sparkles: ([4f5a03b](https://github.com/LerianStudio/midaz-fork/commit/4f5a03b920961e33a76d96ead2c05500f97020f8))
* create transaction using json based on dsl struct :sparkles: ([a2552ed](https://github.com/LerianStudio/midaz-fork/commit/a2552ed74b40e92963b265f1defd69ab32d43482))
* create two methods, validate type and validate currency validate ISO 4217 :bug: ([09c622b](https://github.com/LerianStudio/midaz-fork/commit/09c622b908989bd334fab244e3639f312ca1b0df))
* create update transaction by status; :sparkles: ([181ba8a](https://github.com/LerianStudio/midaz-fork/commit/181ba8a0a621698069f348aabacfd8c741b1ec93))
* created asset command, creation of the create subcommand of the asset command ([bdace84](https://github.com/LerianStudio/midaz-fork/commit/bdace84be5e1d8909439a5d91d67cf86e16d6e90))
* created subcommand list of the command asset ([c2d19fc](https://github.com/LerianStudio/midaz-fork/commit/c2d19fc6bdb29b64f9f5435dd8dcb5d23115ad04))
* dsl validations nuances to sources and distribute :sparkles: ([07452a7](https://github.com/LerianStudio/midaz-fork/commit/07452a79f724399c8f3f42a8181ec7de4532032c))
* **transaction:** exemples files for test :sparkles: ([ad65108](https://github.com/LerianStudio/midaz-fork/commit/ad6510803495b9f234a2b92f37bbadd908ca27ba))
* generate new query to search account by ids :sparkles: ([aa5d147](https://github.com/LerianStudio/midaz-fork/commit/aa5d147151fdbc814a41e7ba58496f8c3bce2989))
* Get asset rates - part 2 :sparkles: ([52d5be4](https://github.com/LerianStudio/midaz-fork/commit/52d5be459eba786409cad4b9feee900a8c6451c4))
* Get asset rates :sparkles: ([48c5dec](https://github.com/LerianStudio/midaz-fork/commit/48c5deccfeebf564b55b6e492271f5dde4585055))
* gitaction to update midaz submodule in midaz-full :sparkles: ([5daafa6](https://github.com/LerianStudio/midaz-fork/commit/5daafa6d397cb975db329ff83f80992903407eb1))
* grpc server starting with http sever togheter :sparkles: ([6d12e14](https://github.com/LerianStudio/midaz-fork/commit/6d12e140d21b28fe70d2f339a05cba4744cbce60))
* implement auth on transaction :sparkles: ([a183909](https://github.com/LerianStudio/midaz-fork/commit/a183909b1122ff19dbddb08b3fa51771a4c68738))
* implement get operation by account :sparkles: ([9137bc1](https://github.com/LerianStudio/midaz-fork/commit/9137bc126f902d23a482e1894995c2cf9bb77230))
* implement get operation by portfolio :sparkles: ([1e9322f](https://github.com/LerianStudio/midaz-fork/commit/1e9322f8257672d95d850739609af87c673d7b56))
* implement get operation by portfolio :sparkles: ([35702ae](https://github.com/LerianStudio/midaz-fork/commit/35702ae99ed667a001a317f8932796d6e540d32a))
* implement get operations by account :sparkles: ([1a75922](https://github.com/LerianStudio/midaz-fork/commit/1a7592273ef8e11382c37ff1f78ee921007ef319))
* implement get operations by portfolio :sparkles: ([966e5c5](https://github.com/LerianStudio/midaz-fork/commit/966e5c5f198381081a9f3a403c7e74c007f80785))
* implement get transaction by id :sparkles: ([a9f1935](https://github.com/LerianStudio/midaz-fork/commit/a9f193516313d16e8ed349b7f469001a479fa40a))
* implement handler; :sparkles: ([dc9df25](https://github.com/LerianStudio/midaz-fork/commit/dc9df25a6c770a7f361094bd835ae042ad5a1aec))
* implement new validations to accounts and dsl and save on operations :sparkles: ([53b7a3a](https://github.com/LerianStudio/midaz-fork/commit/53b7a3a673ff7d3fcdb2eee3498239a1d20e3c29))
* implement on cqrs; :sparkles: ([d122ba6](https://github.com/LerianStudio/midaz-fork/commit/d122ba63d7652188622a7a6795616b19fdc86153))
* implement on routes; :sparkles: ([db9b12f](https://github.com/LerianStudio/midaz-fork/commit/db9b12fc69f37e63e7b2006638acd439d3f51035))
* implement patch operation :sparkles: ([d4c6e5c](https://github.com/LerianStudio/midaz-fork/commit/d4c6e5c3823b44b6b3466342f9cc6c24f21e3e05))
* implement producer and consumer on adapters :sparkles: ([4ff04d4](https://github.com/LerianStudio/midaz-fork/commit/4ff04d4295d7adf12f96815070c2f987bb6cc231))
* implement rabbitmq config, inject and wire; :sparkles: ([5baae29](https://github.com/LerianStudio/midaz-fork/commit/5baae29c08e680c65419c7457ec1adc1ce6d4f9a))
* implement rabbitmq on ledger :sparkles: ([17a9c3d](https://github.com/LerianStudio/midaz-fork/commit/17a9c3da33d2c6a8c9720b7d5d7c550a98b35a04))
* implement token to call grpc :sparkles: ([b1fc617](https://github.com/LerianStudio/midaz-fork/commit/b1fc617c95a1aecfefd35a48ef6f069b08397e77))
* implement update account method; change name account to client when get new account proto client; :sparkles: ([5aae505](https://github.com/LerianStudio/midaz-fork/commit/5aae5050878c28bce20937240dea0ed5efe1cbf0))
* Implement UpdateTransaction and GetAllTTransactions :sparkles: ([d2c0e5d](https://github.com/LerianStudio/midaz-fork/commit/d2c0e5d0a729f67973e8328220fe12e6ab2ffdc3))
* implementation mock :sparkles: ([481e856](https://github.com/LerianStudio/midaz-fork/commit/481e856bf004dc4539c0105cba7bd3d05859c1e5))
* implements custom validators for metadata fields :sparkles: ([005446e](https://github.com/LerianStudio/midaz-fork/commit/005446ef8e5cb6ae6b3aa879586328e28046bd34))
* implements handler for parsing UUID path parameters :sparkles: ([6baa571](https://github.com/LerianStudio/midaz-fork/commit/6baa571275c876ab48760f882e48a400bd892196))
* implements method to check if a ledger exists by name in an organization :sparkles: ([9737579](https://github.com/LerianStudio/midaz-fork/commit/973757967817027815cc1a5497247af3e26ea587))
* implements new function to parse Metadata from requests :sparkles: ([d933a58](https://github.com/LerianStudio/midaz-fork/commit/d933a58ee7abee5893399ce3bc19bb25ad7207f7))
* implements producer and consumer with interface and implementation :sparkles: ([5dccc86](https://github.com/LerianStudio/midaz-fork/commit/5dccc86eeb1847dc8dc99d835b6a0fed5888b043))
* implements transaction api using grcp to get account on ledger :sparkles: ([7b19915](https://github.com/LerianStudio/midaz-fork/commit/7b199150850a41d5a1bb80b725d7bc8db296e10a))
* init of implementing rabbitmq :sparkles: ([ba9dc6f](https://github.com/LerianStudio/midaz-fork/commit/ba9dc6f567d592ba6628ea61273d970e867b53e6))
* init transaction ([b696d05](https://github.com/LerianStudio/midaz-fork/commit/b696d05af93b45841987cb56a6e3bd85fdc7ff90))
* initialize CLI with root and version commands :sparkles: ([6ebff8a](https://github.com/LerianStudio/midaz-fork/commit/6ebff8a40ba097b0eaa4feb1106ebc29a5ba84dc))
* insert operations on database after insert transaction :sparkles: ([cc03f5e](https://github.com/LerianStudio/midaz-fork/commit/cc03f5ed7c2e09437d6faa7e0bac9aae73ceda9e))
* Keto Stack Included in Docker Compose file - Auth ([c5c2831](https://github.com/LerianStudio/midaz-fork/commit/c5c28311b661948c922e541cc618e30bcf878313))
* Keto Stack Included in Docker Compose file - Auth ([7be883f](https://github.com/LerianStudio/midaz-fork/commit/7be883fb0a7851d6798eeadfbc79938d20ba4129))
* method delete rest api ledger ([e8917de](https://github.com/LerianStudio/midaz-fork/commit/e8917ded93e7fb3d9bbaa38e66c5734e1fe8b41b))
* Open tech for all ([cd4cf48](https://github.com/LerianStudio/midaz-fork/commit/cd4cf4874503756b6b051723f512fde41323e609))
* post rest organization ([e7de90d](https://github.com/LerianStudio/midaz-fork/commit/e7de90d241a9d0679a9ea57669784e9b5942a91c))
* product name required :sparkles: ([e3c4a51](https://github.com/LerianStudio/midaz-fork/commit/e3c4a511ef527de01dd9e4032ca9861fa7273bfc))
* re run mock :sparkles: ([5cd0b70](https://github.com/LerianStudio/midaz-fork/commit/5cd0b7002a7fb416cf7a316cb050a565afa17182))
* require code :sparkles: ([40d1bbd](https://github.com/LerianStudio/midaz-fork/commit/40d1bbd7f54c85aaab279e36754274df93d12a34))
* rest get id command describe ([4e80174](https://github.com/LerianStudio/midaz-fork/commit/4e80174534057e0e3fbcfdce231c66103308946f))
* test unit command create ledger ([93754de](https://github.com/LerianStudio/midaz-fork/commit/93754deae69c2167e4ca9d3bc2def0b1fdd9e8ff))
* update account by id and get account by alias by grpc :sparkles: ([bf98e11](https://github.com/LerianStudio/midaz-fork/commit/bf98e11eba0e8a33eddd52e1cde4226deb5af872))
* update go version 1.22 to 1.23; :sparkles: ([1d32f7e](https://github.com/LerianStudio/midaz-fork/commit/1d32f7eebd3018ad83d2d7f86a0a502d859ff08e))
* validate account type :sparkles: ([6dd3fa0](https://github.com/LerianStudio/midaz-fork/commit/6dd3fa09e4cd43668ad33eec0f0533e775117e1e))
* validate code for all types :sparkles: ([c0e7b31](https://github.com/LerianStudio/midaz-fork/commit/c0e7b3179839c720f24ce2da00e5c20172616f10))
* **logging:** wrap zap logger implementation with otelzap :sparkles: ([d792e65](https://github.com/LerianStudio/midaz-fork/commit/d792e651312d63a3812d1d737710db2f0329e1d3))


### Bug Fixes

*  adjust normalization of values ​​with decimal places for remaining :bug: ([fc4f220](https://github.com/LerianStudio/midaz-fork/commit/fc4f22035b622aa88f1c7ebb1652a2da96d278ff))
* (cqrs): remove delete metadata when update object with field is null ([9142901](https://github.com/LerianStudio/midaz-fork/commit/91429013d88bbfc5183487284bde8f11a4f00297))
* accept only [@external](https://github.com/external) accounts to be negative values :bug: ([909eb23](https://github.com/LerianStudio/midaz-fork/commit/909eb23613df8b284190fa490802239dcd256ebc))
* account proto class updated with all fields. :bug: ([0f00bb7](https://github.com/LerianStudio/midaz-fork/commit/0f00bb79be7fb9ec20723c4f56cd607e6ef144ad))
* add -d command in docker up :bug: ([c9dc679](https://github.com/LerianStudio/midaz-fork/commit/c9dc6797b24bb5915826670330b862d39cb250db))
* add -d on docker compose up :bug: ([0322e13](https://github.com/LerianStudio/midaz-fork/commit/0322e13cf0cbbc1693cd21352ccb6f142b71d835))
* add and change fields allowSending and allowReceiving on portfolio and accounts :bug: ([eeba628](https://github.com/LerianStudio/midaz-fork/commit/eeba628b1f749e7dbbcb3e662d92dbf7f6208a5a))
* add auth on the new route :bug: ([ed51df9](https://github.com/LerianStudio/midaz-fork/commit/ed51df902e852469c29d6b4a9e37f772515ed180))
* add chartofaccounts in dsl struct :bug: ([92325c2](https://github.com/LerianStudio/midaz-fork/commit/92325c23dfcc5c707f7048d94dd7f6147373169a))
* add clean-up step for existing backup folder in PostgreSQL replica service in docker-compose ([28be466](https://github.com/LerianStudio/midaz-fork/commit/28be466b7dda2f3dd100b73452c90d93ca574eda))
* add comments :bug: ([5c1bbf7](https://github.com/LerianStudio/midaz-fork/commit/5c1bbf7df3be2fc1171c06ac720bc035535331ff))
* add comments :bug: ([dfd765f](https://github.com/LerianStudio/midaz-fork/commit/dfd765fab6f1c860879e096eeb2f9527e998d820))
* add container_name on ledger docker-compose.yml :bug: ([8f7e028](https://github.com/LerianStudio/midaz-fork/commit/8f7e02826d104580835603b7d8edc6be1d4662f1))
* add error treatment when extracting dsl file from header and get creating buffer error :bug: ([807a706](https://github.com/LerianStudio/midaz-fork/commit/807a706a810f0b729e43472abaa93db5d96675be))
* add field boolean to help to know if is from or to struct :bug: ([898fa5d](https://github.com/LerianStudio/midaz-fork/commit/898fa5dbe14352a3381dfc9c58e9d95b2e15b1c4))
* add field sizing to onboarding and portfolio domain structs :bug: ([df44228](https://github.com/LerianStudio/midaz-fork/commit/df44228ecdc667a818daf218aefcc0f5012e9821))
* add field UseMetadata  to use on query on mongodb when not use metadata field remove limit and skip to get all :bug: ([fce6bfb](https://github.com/LerianStudio/midaz-fork/commit/fce6bfb2e9132a14205a90dda6164c7eaf7e97f4))
* add in string utils regex features like, ignore accents... :bug: ([a80a698](https://github.com/LerianStudio/midaz-fork/commit/a80a698b76375f809ab98b503fda72396ccb9744))
* add lib :bug: ([55f0aa0](https://github.com/LerianStudio/midaz-fork/commit/55f0aa0fea1b40cce38da9d35e296e66daf15d5c))
* add log; :bug: ([3a71282](https://github.com/LerianStudio/midaz-fork/commit/3a712820a16ede4cd50cdc1729c5abf0507950b0))
* **logging:** add logger sync to server for graceful shutdown :bug: ([c51a4af](https://github.com/LerianStudio/midaz-fork/commit/c51a4af37d9f0f646c6386505138ab9273aeaefd))
* add make set_env on make file; :bug: ([6c6bead](https://github.com/LerianStudio/midaz-fork/commit/6c6bead89a289a52993d7e75b3687753637f4624))
* add nil validation for status description in account toProto func :bug: ([387b856](https://github.com/LerianStudio/midaz-fork/commit/387b8560029bdd49010e28312da7d0038db16dba))
* add omitempty to all status domain structs :bug: ([c946146](https://github.com/LerianStudio/midaz-fork/commit/c94614651d1a14683cc53808227a2d3c3753b8b7))
* add opentelemetry traces to asset rate endpoints and small adjusts to ledger metadata tracing and wire inject file :bug: ([d933b13](https://github.com/LerianStudio/midaz-fork/commit/d933b13db0b539ba19471af40c808e669baade93))
* **account:** add organizationID and ledgerID to the grpc account funcs :bug: ([39b29e7](https://github.com/LerianStudio/midaz-fork/commit/39b29e7e41288360a5cffe2a3bbb60e63738f98e))
* add parentheses on find name or asset query; :bug: ([9b71d2e](https://github.com/LerianStudio/midaz-fork/commit/9b71d2ee9bafba37b0eb9e1a0f328b5d10036d1e))
* add required in asset_code; :bug: ([d2481eb](https://github.com/LerianStudio/midaz-fork/commit/d2481ebf4d3007df5337394c151360aca28ee69a))
* add solution to avoid nolint:gocyclo in business error messages handler :bug: ([a293625](https://github.com/LerianStudio/midaz-fork/commit/a293625ea937c6a7ccecf94a254933673bf50816))
* add span error setting on withTelemetry file :bug: ([40a2008](https://github.com/LerianStudio/midaz-fork/commit/40a20089658b8cc58d52be224a1478c55623a693))
* add validation for allowReceiving and allowSending status fields in create endpoints for all components :bug: ([3dad79d](https://github.com/LerianStudio/midaz-fork/commit/3dad79d7a5ea23ff26c6976ced69c5083a4c31cf))
* add validation for status fields in create endpoints for all components :bug: ([0779976](https://github.com/LerianStudio/midaz-fork/commit/077997648bdf3f156291208fdc85c30614e2ff93))
* adjust account proto in common to improve requests and responses on ledger :bug: ([844d994](https://github.com/LerianStudio/midaz-fork/commit/844d9949171b04860fc14eef888a0d2732c63bb2))
* adjust balance_scale can not be inserted on balance_on_hold :bug: ([9482b5a](https://github.com/LerianStudio/midaz-fork/commit/9482b5a11ab75f823cbdbbcf3b279c08716564a4))
* adjust cast of int to uint64 because gosec G115 :bug: ([d1d62fb](https://github.com/LerianStudio/midaz-fork/commit/d1d62fb2f0e76a96dce841d6018abd40e3d88655))
* adjust centralized errors name to comply with stylecheck and other lint issues :bug: ([a06361d](https://github.com/LerianStudio/midaz-fork/commit/a06361da717d4330445ab589b5fd9bf800d18743))
* adjust data type in transaction from json endpoint in postman collection :bug: ([107b60f](https://github.com/LerianStudio/midaz-fork/commit/107b60f980ae2138e497216f95032ba2200a5858))
* adjust grpc account service :bug: ([2679e9b](https://github.com/LerianStudio/midaz-fork/commit/2679e9bfe2d94fcc201e5672cec1f86feca5eb95))
* adjust import alias :bug: ([c31d28d](https://github.com/LerianStudio/midaz-fork/commit/c31d28d20c30d72a5c7fe87c77aa2752124c269a))
* adjust import; :bug: ([64b3456](https://github.com/LerianStudio/midaz-fork/commit/64b345697ba0636247e742a27da6251dcb9efc2f))
* adjust lint ineffectual assignment to ctx :bug: ([e78cef5](https://github.com/LerianStudio/midaz-fork/commit/e78cef569a78206b6859c0eb4ad51486fa8c72a3))
* adjust make lint ([dacca62](https://github.com/LerianStudio/midaz-fork/commit/dacca62bfcb272c9d70c10de95fdd4473d3b97c2))
* adjust method findAll to paginate using keyset and squirrel (not finished) :bug: ([8f4883b](https://github.com/LerianStudio/midaz-fork/commit/8f4883b525bb4c88d3aebad0464ce7d27e6177f0))
* adjust migration to id always be not null and use uuid_generate_v4() as default :bug: ([ea2aaa7](https://github.com/LerianStudio/midaz-fork/commit/ea2aaa77a8ecc5e4a502b2d6fcf4d3d97af112f0))
* adjust path mock to generate new files and add new method interface in instrument :bug: ([ecbfce9](https://github.com/LerianStudio/midaz-fork/commit/ecbfce9b4d74dbbb72df384c1f697c9ff9a8772e))
* adjust portfolio, allowreceiving and allowsending; :bug: ([4f16cd1](https://github.com/LerianStudio/midaz-fork/commit/4f16cd10c89504d82eeaa3b89ab498178b2be00a))
* adjust query cqrs for use new method signature :bug: ([d87cc5e](https://github.com/LerianStudio/midaz-fork/commit/d87cc5ebc042c8e22fdaa5f78fd321b558f6b9ff))
* adjust reference to errors in common instead of http package :bug: ([c0deae2](https://github.com/LerianStudio/midaz-fork/commit/c0deae240ba53530ec9750bacf6cf23862c127dc))
* adjust some validation to add and remove values from accounts using scale; :bug: ([d59e19d](https://github.com/LerianStudio/midaz-fork/commit/d59e19d33b51cac8592faf991656cfb2fbf78f33))
* adjust to slice to use append instead use index. :bug: ([990c426](https://github.com/LerianStudio/midaz-fork/commit/990c426f87a485790c6c586aadd35b5ac71bf32f))
* adjust to validate if exists code on assets; :bug: ([583890a](https://github.com/LerianStudio/midaz-fork/commit/583890a6c1d178b95b41666a91600a60d3053123))
* adjust transaction log; :bug: ([823ec66](https://github.com/LerianStudio/midaz-fork/commit/823ec6643f8e54af7fd47acc434c010b0416fd31))
* adjust transaction model and parse :bug: ([060ff1d](https://github.com/LerianStudio/midaz-fork/commit/060ff1d29a02dc71a1d2a761b10d664c7304fcbd))
* ah metadata structure is totally optional now, it caused errors when trying to request with null fields in the api ([3dac45f](https://github.com/LerianStudio/midaz-fork/commit/3dac45fea9bd1c2fef7990289d4c33eb5884d182))
* ajust alias to receive nil :bug: ([19844fd](https://github.com/LerianStudio/midaz-fork/commit/19844fdc8a507ac1060812630419c495cb7bf326))
* asset validate create before to ledger_id :bug: ([da0a22a](https://github.com/LerianStudio/midaz-fork/commit/da0a22a38f57c6d8217e8511abb07592523c822f))
* better formatting for error message :bug: ([d7135ff](https://github.com/LerianStudio/midaz-fork/commit/d7135ff90f50f154a95928829142a37226be7629))
* bring back omitempty on metadata in field _id because cant generate automatic id without :bug: ([d68be08](https://github.com/LerianStudio/midaz-fork/commit/d68be08765d57c7c01d4a9b1f0466070007839c2))
* bugs and new implements features :bug: ([8b8ee76](https://github.com/LerianStudio/midaz-fork/commit/8b8ee76dfd7a2d7c446eab205b627ddf1c87b622))
* business message :bug: ([d3c35d7](https://github.com/LerianStudio/midaz-fork/commit/d3c35d7da834698a2b50e59e16db519132b8786b))
* change conversion of a signed 64-bit integer to int ([2fd77c2](https://github.com/LerianStudio/midaz-fork/commit/2fd77c298a1aa4c74dbfa5e030ec65ca3628afd4))
* **account:** change error for create account with parent account id not found :bug: ([a2471a9](https://github.com/LerianStudio/midaz-fork/commit/a2471a9bf76401015503e61fab6843f9f092bbca))
* change map instantiation; :bug: ([1d3f1e8](https://github.com/LerianStudio/midaz-fork/commit/1d3f1e8178950da03b9320371b140ad752f10cd5))
* change midaz code owner file :bug: ([8f5e2c2](https://github.com/LerianStudio/midaz-fork/commit/8f5e2c202fe6fa9ae9140ac032ad304f97ab34a6))
* change midaz url :bug: ([acbaf9e](https://github.com/LerianStudio/midaz-fork/commit/acbaf9eb081fab39c7ff1c5e53bd12d2063af5eb))
* change of place the fields allow_sending and allow_receiving :bug: ([3be0010](https://github.com/LerianStudio/midaz-fork/commit/3be0010cd92310a5e79d4fe6f876aa3053a5555d))
* change print error to return error :bug: ([2e28f92](https://github.com/LerianStudio/midaz-fork/commit/2e28f9251b91fcfcd77a33492219f27f0bedb5b0))
* complete conn and health on rabbitmq :bug: ([61d1431](https://github.com/LerianStudio/midaz-fork/commit/61d143170704a8cb35b33395e61812fc31f206f5))
* **errors:** correcting invalid account type error message :bug: ([4df336d](https://github.com/LerianStudio/midaz-fork/commit/4df336d420438fd4d7d0ec108006aae14afdf5bc))
* create method to validate if code has letter uppercase :bug: ([36f6c0e](https://github.com/LerianStudio/midaz-fork/commit/36f6c0e295f24a809acde2332d4b6c3b51eefd8b))
* create new users to separate ledger and transaction :bug: ([24f66c8](https://github.com/LerianStudio/midaz-fork/commit/24f66c8bb43938a5e44206853153542b51a9471c))
* create transaction  on postgresql :bug: ([688a16c](https://github.com/LerianStudio/midaz-fork/commit/688a16cc5eb56b99b071b1f21e6e43c6f8758b01))
* create validation on code to certify that asset_code exist on assets before insert in accounts; :bug: ([2375963](https://github.com/LerianStudio/midaz-fork/commit/2375963e26657972f22ac714c905775bdf0ed5d5))
* domain adjust interface with new signature method :bug: ([8ea6940](https://github.com/LerianStudio/midaz-fork/commit/8ea6940ee4a3300eb3a247fde238e1c850bb27fc))
* ensure pg_basebackup runs if directory or postgresql.conf file is missing ([9f9742e](https://github.com/LerianStudio/midaz-fork/commit/9f9742e39fe223a7cda85252935ea0d1cbbf6b81))
* env default local :bug: ([b1d8f04](https://github.com/LerianStudio/midaz-fork/commit/b1d8f0492c7cdd0bc2828b55d5f632f1c2694adc))
* error in the logic not respecting the username and password flags ([b76e361](https://github.com/LerianStudio/midaz-fork/commit/b76e3615a06e48140e57ed74c2d6d06db513e60b))
* filters if any required fields are missing and returns a customized error message :bug: ([7f6c95a](https://github.com/LerianStudio/midaz-fork/commit/7f6c95a4e388f9edb110f19d8ad5f4ca01b1a7ab))
* fix lint name and import sorting issues :bug: ([aeb2a87](https://github.com/LerianStudio/midaz-fork/commit/aeb2a8788ef0af33958ffd8de0c58b7f54d9d6a6))
* fix patch updates to accept only specific fields, not all like put :bug: ([95c2847](https://github.com/LerianStudio/midaz-fork/commit/95c284760b82e0ed3d173ed83728dc03417dc3a5))
* fixes file name typo :bug: ([3cbab1a](https://github.com/LerianStudio/midaz-fork/commit/3cbab1ab19171144d33ee16bbaa87f0b925062e1))
* fixes metadata error messages max length parameters :bug: ([d9f334e](https://github.com/LerianStudio/midaz-fork/commit/d9f334ee8c57b8e3d1ac70ccb4479749380ea3c2))
* Fixing the ory ports - creating organization and group namespace :bug: ([b4a72b4](https://github.com/LerianStudio/midaz-fork/commit/b4a72b4f5aedc2b8763286ffcdad894af3094e01))
* go lint :bug: ([b692801](https://github.com/LerianStudio/midaz-fork/commit/b692801bbb49b4492db0863a05774fa66a2a2746))
* go sec and go lint :bug: ([8a91b07](https://github.com/LerianStudio/midaz-fork/commit/8a91b0746257afe7f4c4dc1ad6ce367b6f019cba))
* go sec and lint; :bug: ([4d22c8c](https://github.com/LerianStudio/midaz-fork/commit/4d22c8c5be0f6498c5305ed01e1121efbe4e8987))
* golang lint mess imports :bug: ([8a40f2b](https://github.com/LerianStudio/midaz-fork/commit/8a40f2bc64a68233c4b55523357062b3741207b6))
* golang sec G601 (CWE-118): Implicit memory aliasing in for loop. (Confidence: MEDIUM, Severity: MEDIUM) :bug: ([9517777](https://github.com/LerianStudio/midaz-fork/commit/9517777b5a37364718351be3824477175ffadafd))
* golint :bug: ([481e1fe](https://github.com/LerianStudio/midaz-fork/commit/481e1fec585ad094dafccb0b4a4e0dc4df600f7c))
* implements RFC merge patch rules for metadata update :bug: ([7cf7bcd](https://github.com/LerianStudio/midaz-fork/commit/7cf7bcdddad9a5b3fd6e548eae6acae3efa1860c))
* insert grpc address and port in environment :bug: ([7813ae3](https://github.com/LerianStudio/midaz-fork/commit/7813ae3dc6df15e7cf5a56c344676e76e930297b))
* insert import reflect :bug: ([f1574e6](https://github.com/LerianStudio/midaz-fork/commit/f1574e660a1ac0d4f833daaddc345d1e72609257))
* insert ledger grpc address and port into transaction .env :bug: ([4be3771](https://github.com/LerianStudio/midaz-fork/commit/4be377158d02369b317f478ccf333ea043bd4573))
* interface signature for organization :bug: ([cb5df35](https://github.com/LerianStudio/midaz-fork/commit/cb5df3529da50ecbe89c9ffa4333029e083b5caf))
* Invalid code format validation :bug: ([e8383ca](https://github.com/LerianStudio/midaz-fork/commit/e8383cac7957d1f0d63ce20f71534052ab1e8703))
* Invalid code format validation :bug: ([4dfe76c](https://github.com/LerianStudio/midaz-fork/commit/4dfe76c1092412a129a60b09d408f71d8a59dca0))
* lint :bug: ([9e5ebf1](https://github.com/LerianStudio/midaz-fork/commit/9e5ebf1f3442efbaffcc4df2dbfe3924c37810f0))
* lint :bug: ([9508657](https://github.com/LerianStudio/midaz-fork/commit/950865748e3fdcf340599c92cd3143ffc737f87f))
* lint and error message :bug: ([be8637e](https://github.com/LerianStudio/midaz-fork/commit/be8637eb10a2ec105a6da841eae56d7ac7b0827d))
* load transaction after patch :bug: ([456f880](https://github.com/LerianStudio/midaz-fork/commit/456f88076c703a55d28ac3178382134afefadbe2))
* logging entity name for metadata creation error :bug: ([1f70e1b](https://github.com/LerianStudio/midaz-fork/commit/1f70e1b1df0c0a67d092ab882e5f57a15d6f49d0))
* login via flag no save token local ([656b15a](https://github.com/LerianStudio/midaz-fork/commit/656b15a964a22eb400fae1716b7c10c649283265))
* make lint :bug: ([5a7847a](https://github.com/LerianStudio/midaz-fork/commit/5a7847aea01f89d606604c4311e4539347ba26f3))
* make lint :bug: ([0281101](https://github.com/LerianStudio/midaz-fork/commit/0281101e99125b103eacafb07f6549137a099bae))
* make lint :bug: ([660698b](https://github.com/LerianStudio/midaz-fork/commit/660698bec3e15616f2c29444c4910542e4e18782))
* make lint issues; :bug: ([96fc0bf](https://github.com/LerianStudio/midaz-fork/commit/96fc0bfcea8fe44f734b97dec6fddd2a6804d792))
* make lint, sec and tests :bug: ([bb4621b](https://github.com/LerianStudio/midaz-fork/commit/bb4621bc8a5a10a03f9312c9ca52a7cacdac6444))
* make lint; :bug: ([3e55c43](https://github.com/LerianStudio/midaz-fork/commit/3e55c436db91bb34c2f61a3671313eaf449988a9))
* make sec and lint; :bug: ([93a3dd6](https://github.com/LerianStudio/midaz-fork/commit/93a3dd6eddc6c3f032a7e5844355b81c93ccbf5f))
* make sec, format, tidy and lint :bug: ([11b9d97](https://github.com/LerianStudio/midaz-fork/commit/11b9d973c405f839a9fc64bcbe1e5a6828345260))
* make sec, lint and tests :bug: ([f10fa90](https://github.com/LerianStudio/midaz-fork/commit/f10fa90e5b7491308e18fadbd2efeb43224c9c1c))
* makefiles adjust commands and logs :bug: ([f5859e3](https://github.com/LerianStudio/midaz-fork/commit/f5859e31ad557b82ce9b0e9346a213e6c3bc75a1))
* merge develop :bug: ([cdaf00d](https://github.com/LerianStudio/midaz-fork/commit/cdaf00d73368bf410cd757e66970d90115a6b258))
* migration alias to receive null :bug: ([9c83a9c](https://github.com/LerianStudio/midaz-fork/commit/9c83a9ccb693031b588a67e5f42b03cc5b26a509))
* mock :bug: ([5b2d152](https://github.com/LerianStudio/midaz-fork/commit/5b2d152ff987638a36bc643796aa9d755b0e53fc))
* mongdb connection and wire to save metadata of transaction :bug: ([05f19a5](https://github.com/LerianStudio/midaz-fork/commit/05f19a55ae0b4b241101a865fc464eff203fc5b6))
* move opentelemetry init to before logger init and move logger provider initialization to otel common file :bug: ([a25af7f](https://github.com/LerianStudio/midaz-fork/commit/a25af7f78c02159b4f39a5eeb9e66675467c617b))
* omits validation error fields if empty :bug: ([313a3cd](https://github.com/LerianStudio/midaz-fork/commit/313a3cd6b60f7dc05f760efbf95b68ffa8885fad))
* omitting empty metadata from responses :bug: ([7878b44](https://github.com/LerianStudio/midaz-fork/commit/7878b44171d326e6cd157c8a4500c17636dca294))
* passing field metadata to instrument :bug: ([87d10c8](https://github.com/LerianStudio/midaz-fork/commit/87d10c8f9f75a593491d4e0843962653b72c069a))
* passing field metadata to portfolio :bug: ([5356e5c](https://github.com/LerianStudio/midaz-fork/commit/5356e5cb22a9957b0c3cff0d0e52a539a2cc7187))
* patch account doesnt return the right data :bug: ([a9c97c2](https://github.com/LerianStudio/midaz-fork/commit/a9c97c2b48b16ae237195777fa8c77d23370e184))
* ports adjust headers :bug: ([97dc2eb](https://github.com/LerianStudio/midaz-fork/commit/97dc2eb660d3369082e950dd338a4a0ac4bffd32))
* regenerate mocks :bug: ([8592e17](https://github.com/LerianStudio/midaz-fork/commit/8592e17ab449151972af43ebc64d6dfdc9975087))
* regenerated mock :bug: ([5383978](https://github.com/LerianStudio/midaz-fork/commit/538397890c5542b311c0cf7df94fa3b8a073dab8))
* remove account http api reference :bug: ([8189389](https://github.com/LerianStudio/midaz-fork/commit/8189389fe7d39dd3dd182c79923a4d1e593dd944))
* remove and update postman :bug: ([0971d13](https://github.com/LerianStudio/midaz-fork/commit/0971d133c9ea969d9c063e8acb7a617edb620be2))
* remove asset_code validation on account :bug: ([05b89c5](https://github.com/LerianStudio/midaz-fork/commit/05b89c52266d1e067ffc429d29405d49f50762dc))
* remove copyloopvar and perfsprint; :bug: ([a181709](https://github.com/LerianStudio/midaz-fork/commit/a1817091640de24bad22e43eaddccd86b21dcf82))
* remove db scan position :bug: ([0129bd0](https://github.com/LerianStudio/midaz-fork/commit/0129bd09ec839881813cf8bbc1aed492d73d20da))
* remove defer because command always be executed before the connection is even used. :bug: ([a5e4d36](https://github.com/LerianStudio/midaz-fork/commit/a5e4d3612123a24ddcb3eec0741116e48f294a1f))
* remove deleted_at is null condition from account consult endpoints and related functions :bug: ([af6e15a](https://github.com/LerianStudio/midaz-fork/commit/af6e15a4798357991e6c1cca5ba9911c0f987bb3))
* remove deprecated metadata validation calls :bug: ([549aa99](https://github.com/LerianStudio/midaz-fork/commit/549aa99b25b0d5e98c27c5de7144206bf8b18c6d))
* remove duplicated currency :bug: ([38b1b8b](https://github.com/LerianStudio/midaz-fork/commit/38b1b8bb7e1c6a138ade8e666d6856d595363a37))
* remove exemples of dsl gold :bug: ([1daa033](https://github.com/LerianStudio/midaz-fork/commit/1daa03307fbb105d95fdad20cecc37d092bf9838))
* remove fiber print startup :bug: ([d47dd20](https://github.com/LerianStudio/midaz-fork/commit/d47dd20ba5c888860b9c07fceb4e4ff2b432a167))
* remove fmt.sprintf :bug: ([1ba33f8](https://github.com/LerianStudio/midaz-fork/commit/1ba33f82cfc9a44e7b92b13b75c064107d656f02))
* remove goconst :bug: ([707be65](https://github.com/LerianStudio/midaz-fork/commit/707be656984aaea2c839be70f6c7c17e84375866))
* **auth:** remove ids from the auth init sql insert :bug: ([0965a7b](https://github.com/LerianStudio/midaz-fork/commit/0965a7b2c46498735ba9d2804fb3e704a49154bd))
* remove json unmarshal from status in method find and findall ([021e5af](https://github.com/LerianStudio/midaz-fork/commit/021e5af12b8ff6791bac9c694e5de157efbad4c7))
* remove line break from generate uuidv7 func :bug: ([7cf4009](https://github.com/LerianStudio/midaz-fork/commit/7cf4009e9dbb984d3aa94e4c3132645f0c99ca0b))
* remove not null from field entity_id in account :bug: ([921b21e](https://github.com/LerianStudio/midaz-fork/commit/921b21ef6bc4c7c9ddb957f48b3849a93c9551ee))
* remove otel-collector from infra module and keep otel-lgtm as the final opentelemetry backend :bug: ([07df708](https://github.com/LerianStudio/midaz-fork/commit/07df7088da9ea48771d562716e5524f451de9848))
* remove pagination from  organization struct to a separated object generic :bug: ([0cc066d](https://github.com/LerianStudio/midaz-fork/commit/0cc066d362104f70775efdb1b3a7b74a6cbd4453))
* remove portfolioID for duplicated alias validation on create account :bug: ([d043045](https://github.com/LerianStudio/midaz-fork/commit/d0430453e5a548d84fab88e6283c298f78e384f6))
* remove producer and consumer from commons :bug: ([fec19a9](https://github.com/LerianStudio/midaz-fork/commit/fec19a901d4af1ec05eaf488ab721c501d2b9714))
* remove short telemetry upload interval used for development purposes :bug: ([64481fb](https://github.com/LerianStudio/midaz-fork/commit/64481fb8fb9c9ea4c8ddc1f3d4b1e66134154782))
* remove squirrel :bug: ([941ded6](https://github.com/LerianStudio/midaz-fork/commit/941ded618a426a4c54a8937234f0f7fa22708def))
* **transaction:** remove test handler :bug: ([8081dcf](https://github.com/LerianStudio/midaz-fork/commit/8081dcf69a654132062a8915cff02b0213765d03))
* **ledger:** remove test handler; :bug: ([2dc3803](https://github.com/LerianStudio/midaz-fork/commit/2dc38035c3db16ea905fd5955eb99788af8edb70))
* remove unique constraint on database in code and reference on accounts; :bug: ([926ca9b](https://github.com/LerianStudio/midaz-fork/commit/926ca9b758d7e69611afa903c035fa01218b108f))
* remove unusable features from mpostgres :bug: ([0e0c090](https://github.com/LerianStudio/midaz-fork/commit/0e0c090850e2cca7dbd20bcff3e9aa0e58eafef0))
* remove unusued alias common :bug: ([cdd77f1](https://github.com/LerianStudio/midaz-fork/commit/cdd77f1681cc8a5ef90a8aaf62592ab7aec91b76))
* remove wrong file auto generated :bug: ([67533b7](https://github.com/LerianStudio/midaz-fork/commit/67533b76f61d8d2683ca155d095309931dd4ca5a))
* removes omitempty to return field even than null :bug: ([030ea64](https://github.com/LerianStudio/midaz-fork/commit/030ea6406baf1a5ced486e4b3b2ab577f44adedf))
* rename .env.exemple to .env.example and update go.sum :bug: ([b6a2a2d](https://github.com/LerianStudio/midaz-fork/commit/b6a2a2dd8fba36b808fd4efc09cdcc3b53d5e708))
* rename get-transaction to get-id-transaction filename :bug: ([96cda1f](https://github.com/LerianStudio/midaz-fork/commit/96cda1f8e7910a27aa9195bcc77317660347367a))
* rename OperationHandler alias :bug: ([866c122](https://github.com/LerianStudio/midaz-fork/commit/866c1222ce1ce14e6524495e9a98f986c334027a))
* rename to put on pattern :bug: ([ec8141a](https://github.com/LerianStudio/midaz-fork/commit/ec8141ae8195d6e6f864ee766bca94bf6e90de03))
* reorganize some class and update wire. :bug: ([af0836b](https://github.com/LerianStudio/midaz-fork/commit/af0836b86395b840b895eea7f1c256b04c5c7d17))
* resolve conflicts :bug: ([bc4b697](https://github.com/LerianStudio/midaz-fork/commit/bc4b697c2e50cd1ec3cd41e0f96cb933a17b6a79))
* resolve G304 CWE-22 potential file inclusion via variable ([91a4350](https://github.com/LerianStudio/midaz-fork/commit/91a43508fda108300aef26d1a5cb9195923ca21b))
* **logging:** resolve logging issues for all routes :bug: ([694dadb](https://github.com/LerianStudio/midaz-fork/commit/694dadb29889d2884920260d6e6ac765e5c672dd))
* return bash on make.sh; :bug: ([0b964ba](https://github.com/LerianStudio/midaz-fork/commit/0b964ba235ef81a1ccce11f6d9a8b1f372a50de9))
* return squirrel :bug: ([7b7c301](https://github.com/LerianStudio/midaz-fork/commit/7b7c30145d24fcca97195b190b448d6b18f1a54a))
* return statements should not be cuddled if block has more than two lines (wsl) :bug: ([136a780](https://github.com/LerianStudio/midaz-fork/commit/136a780f27bb8f2604461efd058b8208029458ad))
* sec and lint; :bug: ([46bf3b2](https://github.com/LerianStudio/midaz-fork/commit/46bf3b29524b286b5361fcb209c3ec5e84714547))
* sec and lint; :bug: ([a60cb56](https://github.com/LerianStudio/midaz-fork/commit/a60cb56960d1d3103e9530e890eeaadc3edb587a))
* **logging:** set capital color level encoder for non-production environments :bug: ([f5f6e73](https://github.com/LerianStudio/midaz-fork/commit/f5f6e7329037de63ba2c6325446c0961eabee4b4))
* set new metadata validators for necessary inputs :bug: ([ead05ab](https://github.com/LerianStudio/midaz-fork/commit/ead05ab8c3cd87e0e87e06f5b112a2c235a7f146))
* sets entityID as a required field for portfolio creation :bug: ([5a74f7d](https://github.com/LerianStudio/midaz-fork/commit/5a74f7d381061ec677ed6c3d1887793deb4fd7ca))
* sets legalName and legalDocument as required fields for creating or updating an organization :bug: ([1dd238d](https://github.com/LerianStudio/midaz-fork/commit/1dd238d77b68e0e847adc0861deb526588a9049e))
* sets name as a required field for creating ledgers :bug: ([534cda5](https://github.com/LerianStudio/midaz-fork/commit/534cda5d9203a6c478baf8980dea2e3fc2170eaf))
* sets name as a required field for portfolio creation :bug: ([ef35811](https://github.com/LerianStudio/midaz-fork/commit/ef358115fba637d8430897b58f87eb5cc2295fb2))
* sets type as a required field for creating accounts :bug: ([a35044f](https://github.com/LerianStudio/midaz-fork/commit/a35044f7d79b4eb3ecd1476d9ac5527e36617fb1))
* setting cursor input and interactive terminal output ([9b45c14](https://github.com/LerianStudio/midaz-fork/commit/9b45c147a68c5fb030e264b65a3c05f32c8eaa04))
* some adjusts :bug: ([8e90ad8](https://github.com/LerianStudio/midaz-fork/commit/8e90ad877f4d6a4c9384492b465b19abe5c29260))
* some adjusts on query header strutc :bug: ([adb03ea](https://github.com/LerianStudio/midaz-fork/commit/adb03eaeb6597009734565967d977a093765f6cd))
* some adjusts; :bug: ([9f45958](https://github.com/LerianStudio/midaz-fork/commit/9f45958bba6cec482d582f4ba12acbdfbff6129d))
* some operation adjust :bug: ([0ab9fa3](https://github.com/LerianStudio/midaz-fork/commit/0ab9fa3b0248e0a0c9a6d1f25b5e5dcfd0bd1d65))
* some update to add and sub accounts; adjust validate accounts balance; :bug: ([e705cbd](https://github.com/LerianStudio/midaz-fork/commit/e705cbd3db086d400ae6440b8b21870d3c28cd49))
* uncomment grafana-lgtm and otel-collector on infra docker-compose :bug: ([07dabfd](https://github.com/LerianStudio/midaz-fork/commit/07dabfd64fa09773e04253aa90ca54e90b356623))
* update .env.example to transaction access accounts on grpc on ledger :bug: ([a643cc6](https://github.com/LerianStudio/midaz-fork/commit/a643cc61c79678f1a1ae91d5eb623f6de04ee2d6))
* update amqp :bug: ([b2d6d22](https://github.com/LerianStudio/midaz-fork/commit/b2d6d22d48251c6b377b503dbf848b07e7c09fc9))
* update bug :bug: ([fdbe8ed](https://github.com/LerianStudio/midaz-fork/commit/fdbe8ed16808ced0782f8d55a5d4d6cd16c9140c))
* update casdoor logger named ping to health check :bug: ([528285e](https://github.com/LerianStudio/midaz-fork/commit/528285e8c2b7421523a94b5b420903813ff3647d))
* update convert uint64 make sec alert :bug: ([3779924](https://github.com/LerianStudio/midaz-fork/commit/3779924a809686cb28f9013aa71f6b6611f063e6))
* update docker compose ledger and transaction to add bridge to use grpc call account :bug: ([4115eb1](https://github.com/LerianStudio/midaz-fork/commit/4115eb1e3522751b875c9bab5ad679d8d8912332))
* update error message for invalid path parameters :bug: ([5942994](https://github.com/LerianStudio/midaz-fork/commit/5942994ed9f31d3a3257f46a829463df2e607d93))
* update field sizing on onboarding and portfolio domain structs accordingly with rfc :bug: ([d8db53d](https://github.com/LerianStudio/midaz-fork/commit/d8db53d506db76772c273f32df2f2c0875146868))
* update find scale right; :bug: ([6e2b45c](https://github.com/LerianStudio/midaz-fork/commit/6e2b45ca6db1b877c430af60bbb61fe85231a3d9))
* update grpc accounts proto reference on transaction and some adjusts to improve readable :bug: ([9930082](https://github.com/LerianStudio/midaz-fork/commit/99300826c63355d9bb8b419d0ff1931fcc63e83a))
* update grpc accounts proto reference on transaction and some adjusts to improve readable pt. 2 :bug: ([11e5c71](https://github.com/LerianStudio/midaz-fork/commit/11e5c71576980b9059444a9708abcf430ede85bd))
* update imports that refactor missed :bug: ([e6e9502](https://github.com/LerianStudio/midaz-fork/commit/e6e95020272edb77ea38cb3fc80b4fc0b901d8b3))
* update imports; :bug: ([a42bbcf](https://github.com/LerianStudio/midaz-fork/commit/a42bbcf083288eb58c97075ab4bafd7a52286dec))
* update infra docker compose to use envs on otel containers and in his yaml config file :bug: ([a6ba7cb](https://github.com/LerianStudio/midaz-fork/commit/a6ba7cbfc07baa095d785c6283c0048243333078))
* update infra otel containers to comply with midaz container name pattern :bug: ([7c067d4](https://github.com/LerianStudio/midaz-fork/commit/7c067d40a23d7543bbae22678d6ce232fdcc1bd4))
* update inject and wire :bug: ([8026c16](https://github.com/LerianStudio/midaz-fork/commit/8026c1653921062738a9a6f3f64ca9907c811daf))
* update injection; :bug: ([2da2b58](https://github.com/LerianStudio/midaz-fork/commit/2da2b5808844b9f248c9d557647e5851d815393d))
* update lib zitadel oidc v2 to v3 :bug: ([1638894](https://github.com/LerianStudio/midaz-fork/commit/1638894d8765da59efb5bfbaf31b337d005538aa))
* **cwe-406:** update lib zitadel oidc v2 to v3 and update some code to non retro compatibility :bug: ([3053f08](https://github.com/LerianStudio/midaz-fork/commit/3053f087bcab2c21535b97814c0ce89899ee05e6))
* update lint; :bug: ([90c929f](https://github.com/LerianStudio/midaz-fork/commit/90c929f6c6cd502acad9aaf70302f8df8970a505))
* update make lint :bug: ([0945d37](https://github.com/LerianStudio/midaz-fork/commit/0945d37a3ab5ce534ab4de6bda463441751dab2a))
* update postman and environments :bug: ([3f4d97e](https://github.com/LerianStudio/midaz-fork/commit/3f4d97e7d3692ad30d8f0fe2dda55ddb44fd5e8b))
* update postman midaz id header to comply with id uppercase pattern :bug: ([a219509](https://github.com/LerianStudio/midaz-fork/commit/a219509bcbd4a147dc82dadc577b200c1fd8147b))
* update postman; :bug: ([4931c51](https://github.com/LerianStudio/midaz-fork/commit/4931c5117ca48a4bbd4471f61e0f1d987da9c60b))
* update proto address and port from ledger and transaction env example :bug: ([95a4f6a](https://github.com/LerianStudio/midaz-fork/commit/95a4f6ac11d37029d4926dcad4026bc6139b5268))
* update scripts to set variable on collection instead of environment :bug: ([e2a52dc](https://github.com/LerianStudio/midaz-fork/commit/e2a52dc5da8b89d5999bae90da292ebce10729cd))
* update slice operation to operations :bug: ([0954fe9](https://github.com/LerianStudio/midaz-fork/commit/0954fe9f9766c8437e222526baa45add2163da2d))
* update some ports on .env :bug: ([b7c58ea](https://github.com/LerianStudio/midaz-fork/commit/b7c58ea75e5c82b8728a785a4b233fa5351c478c))
* update some validate erros. :bug: ([623b4d9](https://github.com/LerianStudio/midaz-fork/commit/623b4d9ebdeb436cdab03faa740e906132b7122a))
* update subcomands version :bug: ([483348c](https://github.com/LerianStudio/midaz-fork/commit/483348c83b6b56858887cb1c8d49142d25b1cdec))
* **logging:** update sync func being called in zap logger for graceful shutdown :bug: ([4ad1ff2](https://github.com/LerianStudio/midaz-fork/commit/4ad1ff2a653500ae9e9d97280bed0eba2f226f4c))
* update test and change QueryHeader path :bug: ([c8b539f](https://github.com/LerianStudio/midaz-fork/commit/c8b539f4b049633e6e6ad7e76b4d990e22c943f6))
* update trace error treatment in ledger find by name repository func :bug: ([cfd86a4](https://github.com/LerianStudio/midaz-fork/commit/cfd86a43f32562482ecf8a0e4822804b46ebf4cc))
* update transaction table after on transaction; :bug: ([296fe6e](https://github.com/LerianStudio/midaz-fork/commit/296fe6e0214a05569fb45d014ae81817b2314d9a))
* update version place in log :bug: ([83980a8](https://github.com/LerianStudio/midaz-fork/commit/83980a8aee40884cb317914c40d89e13c12f6a68))
* updated go.mod and go.sum :bug: ([f8ef00c](https://github.com/LerianStudio/midaz-fork/commit/f8ef00c1d41d68223cdc75780f8a1058cfefac48))
* updated postman :bug: ([750bd62](https://github.com/LerianStudio/midaz-fork/commit/750bd620f8a682e4670707a353bed0aa4eb82a9c))
* updates to get all accounts :bug: ([f536a9a](https://github.com/LerianStudio/midaz-fork/commit/f536a9a5ee1b949b60dded1b3ae7709b4e219d55))
* use operations const instead of account type to save operations :bug: ([e74ce4b](https://github.com/LerianStudio/midaz-fork/commit/e74ce4b4703de7a538b4bf277ea3be4e438adb2f))
* **operation:** use parsed uuids :bug: ([0c5eff2](https://github.com/LerianStudio/midaz-fork/commit/0c5eff2c3e0edeac2e76414557e115883f0e2350))
* **transaction:** use parsed uuids :bug: ([dbb19ad](https://github.com/LerianStudio/midaz-fork/commit/dbb19adf62fd400c0685292f2e4d79170c59d248))
* uses id sent over path to update metadata :bug: ([0918712](https://github.com/LerianStudio/midaz-fork/commit/0918712c9252a3aac93bc6db96cdc2ae879a017f))
* uses parsed UUID for organizationID on create ledger :bug: ([b506dc3](https://github.com/LerianStudio/midaz-fork/commit/b506dc3dfe1e1ea8abdf251ca040ab3a6db163ef))
* uses parsed uuid while creating asset :bug: ([333bf49](https://github.com/LerianStudio/midaz-fork/commit/333bf4921d3f2fd48156ead07ac8b1b29d88d5fa))
* uses parsed uuid while deleting ledger by id :bug: ([8dc3a97](https://github.com/LerianStudio/midaz-fork/commit/8dc3a97f8c859a6948cad099cd61888c8c016bee))
* uses parsed uuid while deleting organization :bug: ([866170a](https://github.com/LerianStudio/midaz-fork/commit/866170a1d2bb849fc1ed002a9aed99d7ee43eecb))
* uses parsed uuid while getting all organization ledgers :bug: ([2260a33](https://github.com/LerianStudio/midaz-fork/commit/2260a331e381d452bcab942f9f06864c60444f52))
* uses parsed uuid while getting and updating a ledger :bug: ([ad1bcae](https://github.com/LerianStudio/midaz-fork/commit/ad1bcae482d2939c8e828b169b566d3a13be95cd))
* uses parsed uuid while retrieving all assets from a ledger :bug: ([aadf885](https://github.com/LerianStudio/midaz-fork/commit/aadf8852154726bd4aef2e3295221b5472236ed9))
* uses parsed uuid while retrieving and updating asset :bug: ([9c8b3a2](https://github.com/LerianStudio/midaz-fork/commit/9c8b3a2f9747117e5149f3a515c8a5b582db4942))
* uses parsed uuid while retrieving organization :bug: ([e2d2848](https://github.com/LerianStudio/midaz-fork/commit/e2d284808c9c1d95d3d1192be2e4ba3e613318dc))
* uses UUID to find asset :bug: ([381ba21](https://github.com/LerianStudio/midaz-fork/commit/381ba2178633863f17cffb327a7ab2276926ce0d))
* uses uuid type instead of string for portfolio creation :bug: ([f1edeef](https://github.com/LerianStudio/midaz-fork/commit/f1edeefe2132c3439c46b41a1f56edcc84b4ccfa))
* validate duplicated alias when updating account :bug: ([60f19c8](https://github.com/LerianStudio/midaz-fork/commit/60f19c89065800cef5172dc43a9772fb425af1af))
* validate fields parentAccountId and parentOrganizationId that can receive null or check value is an uuid string :bug: ([37648ef](https://github.com/LerianStudio/midaz-fork/commit/37648ef363d50d4baf36d9244f9e7f2417ebe040))
* validate omitempty from productId for create and update account :bug: ([a6fd703](https://github.com/LerianStudio/midaz-fork/commit/a6fd703f9b5e8ecd4a08fabe2731e387b1206139))
* validate share to int :bug: ([db12411](https://github.com/LerianStudio/midaz-fork/commit/db1241131d64ae6bd6ea437b0fec98d3f6ea0332))
* validates if a ledger with the same name already exists for the same organization :bug: ([08df20b](https://github.com/LerianStudio/midaz-fork/commit/08df20bf4cdd99fc33ce3d273162addb0023afc6))
* validations to transaction rules :bug: ([769abba](https://github.com/LerianStudio/midaz-fork/commit/769abbae61503e7b916a6246ddc1e6d1155250cc))
* **ledger:** when string ParentOrganizationID is empty set nil ([6f6c044](https://github.com/LerianStudio/midaz-fork/commit/6f6c0449c0833c333d06aeabcfeeeee1108c0256))
